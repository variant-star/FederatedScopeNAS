...
class EnsembleDistillTrainer(EnhanceTrainer):
    ...
    def __init__(self,
        ...
        self.replace_hook_in_train(
            self._hook_on_batch_forward_for_student,
    ...
    def _hook_on_batch_forward_for_student(self, ctx):
        # public_ground_truth
...
class EnsembleDistillSupernetTrainer(EnsembleDistillTrainer):
    """
...
def call_ensemble_distill_supernet_trainer(trainer_type):
    if trainer_type == 'ensemble_distill_supernet_trainer':
        trainer_builder = EnsembleDistillSupernetTrainer
        return trainer_builder


register_trainer('ensemble_distill_trainer', call_ensemble_distill_trainer)
register_trainer('ensemble_distill_supernet_trainer', call_ensemble_distill_supernet_trainer)
